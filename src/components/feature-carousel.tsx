...
const steps = [
  {
    ...
    description: "Simply drag and drop your PDFs. Our AI instantly starts processing them for analysis.",
  },
  {
    id: "2",
    name: "Smart Analysis",
    title: "AI-Powered Analysis",
    description: "Advanced algorithms extract key information, identify patterns, and generate comprehensive insights.",
  },
  {
    id: "3",
    name: "Quick Summary",
    title: "Instant Summaries",
    description: "Get concise, accurate summaries of your documents in seconds, saving hours of reading time.",
  },
  {
    id: "4",
    name: "Search & Export",
    title: "Smart Search",
    description: "Powerful semantic search helps you find exactly what you need across all your documents.",
  },
] as const
